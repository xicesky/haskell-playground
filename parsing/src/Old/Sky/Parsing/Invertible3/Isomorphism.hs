...
module Old.Sky.Parsing.Invertible3.Isomorphism where
...
import Old.Sky.Parsing.Invertible3.PartialType
...
partialIso :: forall s a. (Data s) => s -> (s -> a) -> (a -> s) -> Iso s a
...
partialIsoR :: forall s a. (Data a) => a -> (s -> a) -> (a -> s) -> Iso s a
